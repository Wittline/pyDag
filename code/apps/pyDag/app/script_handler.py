...
class ScriptHandler:
    ...
    def __init__(self, id,  params, script, dag_data, logger):
        self.id = id        
        self.params = params
        self.script = script
    ...
    def __get_gcs_scripts(self, _path):
        ...
        try:
            ...
            self.logger.info(13, [str(ex)], True, exceptions.GoogleCloudError)
    ...
    def format_script(self):
        ...
        self.logger.info(10, [self.script])
